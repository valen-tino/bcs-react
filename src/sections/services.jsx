        ...
        <>
         ...
         <div className='grid md:grid-cols-2 max-w-[1240px] m-auto rounded-full pt-5'>
               <div className='flex flex-col justify-center visible w-full md:items-end sm:hidden' data-aos="fade-down">
                 ...
                 <div className='flex flex-col justify-center invisible w-full sm:visible md:items-end' data-aos="fade-left">
                     <div className='p-10 bg-orange-200 rounded-l-full rounded-br-full '>
                         <img src={visa} className='z-10 w-full h-full'/>
                     </div>
                 </div>
         ...
         <div className='grid md:grid-cols-2 max-w-[1240px] m-auto rounded-full pt-10'>
                 ...
                 <div className='flex flex-col justify-center w-full gap-5 py-0 md:items-start md:px-20 md:py-40'>
                     ...
                     <p className='pl-2 pr-2 text-sm text-bold' data-aos="fade-left">We also offer visa assistance services in Bali, Indonesia. Our services range from helping you apply for a visa to providing the necessary documents for your application. We also assist with any enquiries around the process of obtaining a visa.</p>
                     <h1 className='pl-2 pr-2 text-lg text-bold' data-aos="fade-left">Where do you want to go?</h1>
         ...
         <div className='grid md:grid-cols-2 max-w-[1240px] m-auto rounded-full pt-10'>
               ...
               <div className='flex flex-col justify-center visible w-full md:items-end sm:hidden' data-aos="fade-down">
                 ...
                 <div className='flex flex-col justify-center w-full gap-5 py-0 md:items-start md:px-20 md:py-40'>
                     ...
                     <p className='pl-2 text-sm' data-aos="fade-right">
                       For Bali Only.<br/><br/>
                     ...
                     <h1 className='pl-2 text-lg text-bold' data-aos="fade-right">See Our Gallery!</h1>
                 ...
                 <div className='flex flex-col content-center justify-center invisible w-full md:items-end sm:visible' data-aos="fade-left">
                     <div className='p-10 bg-orange-200 rounded-l-full rounded-br-full'>
                         <img src={wedding} className='z-10 w-full h-full'/>
                     </div>
                 </div>
         ...
         <div className='grid md:grid-cols-2 max-w-[1240px] m-auto rounded-full pt-10'>
                 ...
                 <div className='flex flex-col justify-center w-full gap-5 py-0 md:items-start md:px-20 md:py-40'>
                     ...
                     <h1 className='pl-2 pr-2 text-lg text-bold' data-aos="fade-left">Please feel free to contact us anytime.</h1>
                     <div className='flex flex-wrap gap-2 py-2 pr-2'>
         ...
         <div className='grid md:grid-cols-2 max-w-[1240px] m-auto rounded-full pt-10'>
               ...
               <div className='flex flex-col justify-center visible w-full md:items-end sm:hidden' data-aos="fade-down">
                 ...
                 <div className='flex flex-col justify-center w-full gap-5 py-0 md:items-start md:px-20 md:py-40'>
                     ...
                     <p className='pl-2 text-sm text-bold'data-aos="fade-right">
         ...
         <div className='grid md:grid-cols-2 max-w-[1240px] m-auto rounded-full pt-10'>
                 ...
                 <div className='flex flex-col justify-center w-full gap-5 py-0 md:items-start md:px-20 md:py-40'>
                     ...
                     <div className='pl-2 pr-2'>
                       <p className='text-sm text-bold' data-aos="fade-left">Kami melayani pengurusan dokumen</p><br/><br/>
                       <div className="flex flex-col">
                           <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                               <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8 ">
                                   <div className="overflow-hidden">
